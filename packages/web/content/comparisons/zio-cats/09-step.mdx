...
{/* Entry point patterns with object extends - can't compile in wrapper */}
...
{/* Uses external libraries (ciris, zio-config-magnolia) not in sandbox */}
<ScalaComparisonBlock
  validate={false}
  catsEffectCode={`
    |import cats.effect._
