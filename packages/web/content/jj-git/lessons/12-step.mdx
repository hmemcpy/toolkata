...
<TryIt command="jj log" description="View your commit history" setup={["jj git init --colocate .", "git config user.email 'test@toolkata.com'", "git config user.name 'Test User'", "jj describe -m 'First commit'", "jj new", "jj describe -m 'Second commit'"]} />

<TryIt command="jj status" description="Check current state" setup={["jj git init --colocate .", "git config user.email 'test@toolkata.com'", "git config user.name 'Test User'"]} />

<TryIt command="jj op log" description="View operation history" setup={["jj git init --colocate .", "git config user.email 'test@toolkata.com'", "git config user.name 'Test User'", "jj describe -m 'First commit'", "jj new", "jj describe -m 'Second commit'"]} />
