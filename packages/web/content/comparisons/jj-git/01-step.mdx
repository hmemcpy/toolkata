...
<TryIt command="jj git init --colocate" description="Initialize a colocated jj repository in the sandbox" validate={false} />
...
<TryIt command="jj status" description="Check the repository status" validate={false} />
