...
<TryIt command="jj new" description="Create a new working copy commit" setup={["jj git init --colocate .", "git config user.email 'test@toolkata.com'", "git config user.name 'Test User'"]} />

<TryIt command="echo 'test' > demo.txt" description="Create a demo file" setup={["jj git init --colocate .", "git config user.email 'test@toolkata.com'", "git config user.name 'Test User'", "jj new"]} />

<TryIt command="jj describe -m 'Add demo file'" description="Name your commit" setup={["jj git init --colocate .", "git config user.email 'test@toolkata.com'", "git config user.name 'Test User'", "jj new", "echo 'test' > demo.txt"]} />

<TryIt command="jj show @" description="Check the current commit" setup={["jj git init --colocate .", "git config user.email 'test@toolkata.com'", "git config user.name 'Test User'", "jj new", "echo 'test' > demo.txt", "jj describe -m 'Add demo file'"]} />

<TryIt command="jj new" description="Finalize and create new commit" setup={["jj git init --colocate .", "git config user.email 'test@toolkata.com'", "git config user.name 'Test User'", "jj new", "echo 'test' > demo.txt", "jj describe -m 'Add demo file'"]} />

<TryIt command="jj log" description="Verify in history" setup={["jj git init --colocate .", "git config user.email 'test@toolkata.com'", "git config user.name 'Test User'", "jj new", "echo 'test' > demo.txt", "jj describe -m 'Add demo file'", "jj new"]} />
