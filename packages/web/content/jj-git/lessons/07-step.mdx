...
<TryIt command="jj log -r @" description="Show the current working copy" setup={["jj git init --colocate .", "git config user.email 'test@toolkata.com'", "git config user.name 'Test User'", "jj describe -m 'First commit'", "jj new", "jj describe -m 'Second commit'", "jj new"]} />

<TryIt command="jj log -r '::@'" description="Show ancestry of current commit" setup={["jj git init --colocate .", "git config user.email 'test@toolkata.com'", "git config user.name 'Test User'", "jj describe -m 'First commit'", "jj new", "jj describe -m 'Second commit'", "jj new"]} />

<TryIt command="jj log -r 'heads()'" description="Show all branch heads" validate={false} setup={["jj git init --colocate .", "git config user.email 'test@toolkata.com'", "git config user.name 'Test User'", "jj describe -m 'First commit'", "jj new", "jj describe -m 'Second commit'", "jj new"]} />
