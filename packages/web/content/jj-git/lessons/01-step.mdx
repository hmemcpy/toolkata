...
<TryIt command="jj status" description="Check the repository status" setup={["jj git init --colocate .", "git config user.email 'test@toolkata.com'", "git config user.name 'Test User'"]} />
