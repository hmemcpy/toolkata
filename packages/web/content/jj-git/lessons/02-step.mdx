...
<TryIt command="jj show @" description="Show the current @ commit" setup={["jj git init --colocate .", "git config user.email 'test@toolkata.com'", "git config user.name 'Test User'"]} />

<TryIt command="jj diff" description="Show changes in the working copy" setup={["jj git init --colocate .", "git config user.email 'test@toolkata.com'", "git config user.name 'Test User'"]} />

<TryIt command="jj log" description="See all commits including @" setup={["jj git init --colocate .", "git config user.email 'test@toolkata.com'", "git config user.name 'Test User'"]} />
